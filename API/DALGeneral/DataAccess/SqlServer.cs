...
namespace DALGeneral
{
    public class SqlServer : AdoHelper
    {
        ...
        /// <remarks>
        /// e.g.:  
        ///  XmlReader r = sqlHelper.ExecuteXmlReader(command);
        /// </remarks>
        ...
        protected internal override void AddUpdateEventHandlers(IDbDataAdapter dataAdapter, RowUpdatingHandler rowUpdatingHandler, RowUpdatedHandler rowUpdatedHandler)
        {
            if (rowUpdatingHandler != null)
            {
                this._rowUpdating = rowUpdatingHandler;
                ((SqlDataAdapter)dataAdapter).RowUpdating += new SqlRowUpdatingEventHandler(RowUpdating);
            }

            if (rowUpdatedHandler != null)
            {
                this._rowUpdated = rowUpdatedHandler;
        ...
        protected internal void RowUpdating(object obj, SqlRowUpdatingEventArgs e)
        {
        ...
        protected internal void RowUpdated(object obj, SqlRowUpdatedEventArgs e)
        {
    ...
    internal class SqlDeriveParameters
    {
        ...
        /// <summary>
        /// Populates the Parameters collection of the specified SqlCommand object. This is used for the stored procedure specified in the SqlCommand
        /// </summary>
