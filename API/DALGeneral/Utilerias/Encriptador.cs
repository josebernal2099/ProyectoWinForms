...
namespace DALGeneral.Utilerias
{
    public static class Encriptador
    {
        private const string passwordBase = "pass75dc@avz10";
        private const string saltValor = "s@lAvz";
        private const string Algoritmo = "MD5";
        private const string vector = "@1B2c3D4e5F6g7H8";
        ...
        {
            return Encriptar(textoQueEncriptaremos, passwordBase, saltValor, Algoritmo, 1, vector, 128);
        }
        ...
        public static string Desencriptar(string textoEncriptado)
        {
            ...
            return Desencriptar(textoEncriptado, passwordBase, saltValor, Algoritmo, 1, vector, 128);
        }
        /// <summary> 
